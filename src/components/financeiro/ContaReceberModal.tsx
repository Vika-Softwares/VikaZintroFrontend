...
import { X, DollarSign, Calendar, FileText, Users, Tag, MessageSquare } from 'lucide-react';
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className={`w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.cliente ? 'border-red-500' : ''}`}
                      >
